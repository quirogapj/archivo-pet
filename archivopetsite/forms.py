...
class SignUpForm(UserCreationForm):
    ...
    calle_veterinaria = forms.CharField(max_length=30, help_text='Requerido.', label='Calle')
    numero_calle_veterinaria = forms.IntegerField(help_text='Requerido.', label='Número')
    ...
    telefono_veterinaria = forms.CharField(max_length=30, help_text='Requerido.', label='Teléfono')
    telefono_celular = forms.CharField(max_length=30, required=False, help_text='Opcional.', label='Celular')
